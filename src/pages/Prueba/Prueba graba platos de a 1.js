...
const [plato, setPlato] = useState({...platos[indice]});  
...
const cathInputs = (e) => {
  ...
  return (
    <div>
        <Box sx={{ flexGrow: 1 ,}}>
        <Grid container spacing={{ xs: 1, md: 4, lg: 5 }} columns={{ xs: 1, sm: 1, md: 1, lg: 1 }} display="flex" justifyContent="center">
            <Grid item  >
            <Box component="form" sx={{ '& > :not(style)': { m: 1, width: '50ch' }   }}   >
      
                 <TextField id='indice' variant="outlined"  onChange={cathInputs} value={indice} />  
                <TextField id='indice' variant="outlined"  onChange={cathInputs} value={plato.indice} />  
                <TextField id='categoria' variant="outlined"  onChange={cathInputs} value={plato.categoria} />  
                <TextField id='descripcion' variant="outlined"  onChange={cathInputs} value={plato.descripcion} />  
                <TextField id='precio' variant="outlined"  onChange={cathInputs} value={plato.precio} />  
                <TextField id='url' variant="outlined"  onChange={cathInputs} value={plato.url} />
      
                  <Button variant="contained" startIcon={<SaveIcon />}
                            onClick={agregarPlato}> Grabar
                 </Button>
            </Box>
           </Grid>
        </Grid>
